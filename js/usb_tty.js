...
const kDefaultPolyfillOptions = {
    protocol: "UsbCdcAcm",
    // usbControlInterfaceClass: 0xFF,
    usbTransferInterfaceClass: 0xFF,
};
/**
        ...
        (async () => {
            ...
            try {
                while (datalen_ == 0 && retryc_ > 0) {
                    ...
                    datalen_ = result.data.byteLength;
                    if ((datalen_ > 0) && ((_a = result.data) === null || _a === void 0 ? void 0 : _a.buffer)) {
...
class SerialPort {
    ...
    addEventListener(e, cb) {
        navigator.usb.addEventListener(e, cb);
    }
}
...
const usb_tty_serial = new Serial();
